...
// session projection can run. Register the plugin-owned log event when the
// current harness exposes its merge-extensible vocabulary set; older DSH
// builds without that export continue to load the provider normally.
const knownSessionEventTypes = DshSession.KNOWN_SESSION_EVENT_TYPES;
