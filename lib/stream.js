...
export function classifyError(message) {
  ...
  if (
    /(?:web.?search|hosted.?search|external_web_access|indexed_web_access)/i.test(message) &&
    /\b400\b|unsupported|not.?support|invalid|unknown|unavailable|not.?available|not.?allowed|disabled/i.test(message)
  ) {
    return "CODEX_WEB_SEARCH_UNSUPPORTED";
  }
