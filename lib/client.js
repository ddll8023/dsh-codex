window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function strictLoginInputSchema(parse) {
      return { mode: "strict", typeSymbol: "dsh-codex#CodexLoginInput", schema: { parse } };
    }
    ...
    const CODEX_ACCOUNT_REMOTE = {
      ...
      descriptors: [
        { id: "dsh-codex#codexAccount/getStatus", service: "codexAccount", namespace: "codexAccount", method: "getStatus", invocation: { kind: "direct" }, parameters: [], result: strictAccountSchema(assertAccountStatus) },
        {
          ...
          method: "startLogin",
          invocation: { kind: "direct" },
          parameters: [{ name: "input", wire: "input", source: "json", codec: strictLoginInputSchema(assertLoginInput) }],
          result: strictAccountSchema((v) => v),
        },
